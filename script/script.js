...
const m_pos = { x: -1, y: -1 };// cursor coordinates relatively to the video frame
const l_line = $('svg line').length - 1;// index of the last line
...
$('#streaming-video').click(() => {
  ...
  if (mode != 'Set Count Region') {
    ...
    $(document.createElementNS('http://www.w3.org/2000/svg', 'line')).attr({
      x1: m_pos.x, y1: m_pos.y, x2: m_pos.x, y2: m_pos.y,
    }).appendTo('svg');
  }
});
